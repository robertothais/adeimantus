...
namespace :cluster do
  ...
  desc <<-DESC
    Deploys your project. This calls both `update' and `reload'. Note that \
  ...
  desc <<-DESC
    ...
    handy if you want to deploy, but not immediately reload your application.
  DESC
  task :update do
    transaction do
      update_code
  ...
  desc <<-DESC
    ...
    task (if you want to perform the `reload' task separately).
  ...
  desc <<-DESC
    ...
    deploy, including `reload') or the 'update' task (which does everything \
    except `reload').
  DESC
  ...
  namespace :rollback do
    ...
    desc <<-DESC
      ...
      to call `rollback' instead, as it performs a `reload' as well.
    DESC
    ...
    desc <<-DESC
      Rolls back to a previous version and reloads. This is handy if you ever \
